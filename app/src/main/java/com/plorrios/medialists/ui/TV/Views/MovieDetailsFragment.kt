...
import com.plorrios.medialists.databinding.FragmentMovieDetailsBinding
...
class MovieDetailsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val url = "https://api.themoviedb.org/3/movie/" + args.movieId + "?api_key=" + getString(R.string.TMDB_API_Key) +
                "&language=en-US"
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                activity?.runOnUiThread {
                    ...
                    binding.button.setOnClickListener {
                        ...
                        val movie = Gson().fromJson(jsonObject.toString(), TVObjects.Movie::class.java)

                        val list = activity?.db?.TVListDao()?.get(args.listName)

                        val item = tvItems(movie.id.toString(), movie.title,"Movie" ,list?.id.toString())
                        ...
                        if (activity?.isSubscriber == true && activity?.hasConnection == true) {
                            ...
                            db.collection("Users")
                                ...
                                .collection("TVLists").document(args.listName).collection("list")
        ...
        if (activity?.db?.TVDao()?.get(args.movieId.toString()) != null){
